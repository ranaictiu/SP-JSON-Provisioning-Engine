...
SP.WorkflowServices.WorkflowServiceHealthStatus = function() {}
SP.WorkflowServices.WorkflowServiceHealthStatus.prototype = {
    active: 0, 
    noScope: 1, 
    notConnected: 2, 
    suspended: 3, 
...
SP.WorkflowServices.WorkflowServiceHealthStatus.registerEnum('SP.WorkflowServices.WorkflowServiceHealthStatus', false);
...
SP.WorkflowServices.WorkflowDefinitionCollection.prototype = {
    ...
    sort: function SP_WorkflowServices_WorkflowDefinitionCollection$sort() {ULS8GF:;
        var $v_0 = this.get_context();
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'Sort', null);
        $v_0.addQuery($v_1);
    }
}
...
SP.WorkflowServices.WorkflowDeploymentService.prototype = {
    ...
    enumerateIntegratedApps: function SP_WorkflowServices_WorkflowDeploymentService$enumerateIntegratedApps() {ULS8GF:;
        var $v_0 = this.get_context();
        var $v_1;
        $v_1 = new SP.ClientObjectList($v_0, new SP.ObjectPathMethod($v_0, this.get_path(), 'EnumerateIntegratedApps', null), SP.AppInstance);
        return $v_1;
    },
    
    isIntegratedApp: function SP_WorkflowServices_WorkflowDeploymentService$isIntegratedApp() {ULS8GF:;
        var $v_0 = this.get_context();
        var $v_1;
        var $v_2 = new SP.ClientActionInvokeMethod(this, 'IsIntegratedApp', null);
        $v_0.addQuery($v_2);
...
SP.WorkflowServices.WorkflowServicesManager.prototype = {
    ...
    get_serviceHealthStatus: function SP_WorkflowServices_WorkflowServicesManager$get_serviceHealthStatus() {ULS8GF:;
        this.checkUninitializedProperty('ServiceHealthStatus');
        return ((this.get_objectData().get_properties()['ServiceHealthStatus']));
    },
    ...
    initPropertiesFromJson: function SP_WorkflowServices_WorkflowServicesManager$initPropertiesFromJson(parentNode) {ULS8GF:;
        ...
        $v_0 = parentNode.ServiceHealthStatus;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.get_objectData().get_properties()['ServiceHealthStatus'] = ((SP.DataConvert.fixupType(this.get_context(), $v_0)));
            delete parentNode.ServiceHealthStatus;
        }
    },
    
    isIntegratedApp: function SP_WorkflowServices_WorkflowServicesManager$isIntegratedApp() {ULS8GF:;
        var $v_0 = this.get_context();
        var $v_1;
        var $v_2 = new SP.ClientActionInvokeMethod(this, 'IsIntegratedApp', null);
        $v_0.addQuery($v_2);
...
SP.WorkflowServices.WorkflowSubscription.prototype = {
    ...
    get_parentContentTypeId: function SP_WorkflowServices_WorkflowSubscription$get_parentContentTypeId() {ULS8GF:;
        this.checkUninitializedProperty('ParentContentTypeId');
        return ((this.get_objectData().get_properties()['ParentContentTypeId']));
    },
    
    set_parentContentTypeId: function SP_WorkflowServices_WorkflowSubscription$set_parentContentTypeId(value) {ULS8GF:;
        this.get_objectData().get_properties()['ParentContentTypeId'] = value;
        if ((this.get_context())) {
            this.get_context().addQuery(new SP.ClientActionSetProperty(this, 'ParentContentTypeId', value));
        }
        return value;
    },
    ...
    initPropertiesFromJson: function SP_WorkflowServices_WorkflowSubscription$initPropertiesFromJson(parentNode) {ULS8GF:;
        ...
        $v_0 = parentNode.ParentContentTypeId;
        if (!SP.ScriptUtility.isUndefined($v_0)) {
            this.get_objectData().get_properties()['ParentContentTypeId'] = ($v_0);
            delete parentNode.ParentContentTypeId;
        }
...
SP.WorkflowServices.WorkflowSubscriptionCollection.prototype = {
    ...
    sort: function SP_WorkflowServices_WorkflowSubscriptionCollection$sort() {ULS8GF:;
        var $v_0 = this.get_context();
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'Sort', null);
        $v_0.addQuery($v_1);
    }
...
SP.WorkflowServices.WorkflowSubscriptionService.prototype = {
    ...
    registerInterestInHostWebList: function SP_WorkflowServices_WorkflowSubscriptionService$registerInterestInHostWebList(listId, eventName) {ULS8GF:;
        var $v_0 = this.get_context();
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'RegisterInterestInHostWebList', [ listId, eventName ]);
        $v_0.addQuery($v_1);
    },
    ...
    unregisterInterestInHostWebList: function SP_WorkflowServices_WorkflowSubscriptionService$unregisterInterestInHostWebList(listId, eventName) {ULS8GF:;
        var $v_0 = this.get_context();
        var $v_1 = new SP.ClientActionInvokeMethod(this, 'UnregisterInterestInHostWebList', [ listId, eventName ]);
        $v_0.addQuery($v_1);
    },
    ...
    enumerateSubscriptionsByListWithContentType: function SP_WorkflowServices_WorkflowSubscriptionService$enumerateSubscriptionsByListWithContentType(listId, includeContentTypeSpecified) {ULS8GF:;
        var $v_0 = this.get_context();
        var $v_1;
        $v_1 = new SP.WorkflowServices.WorkflowSubscriptionCollection($v_0, new SP.ObjectPathMethod($v_0, this.get_path(), 'EnumerateSubscriptionsByListWithContentType', [ listId, includeContentTypeSpecified ]));
        return $v_1;
    },
    
    enumerateSubscriptionsByListAndParentContentType: function SP_WorkflowServices_WorkflowSubscriptionService$enumerateSubscriptionsByListAndParentContentType(listId, parentContentTypeId, includeNoContentTypeSpecified) {ULS8GF:;
        var $v_0 = this.get_context();
        var $v_1;
        $v_1 = new SP.WorkflowServices.WorkflowSubscriptionCollection($v_0, new SP.ObjectPathMethod($v_0, this.get_path(), 'EnumerateSubscriptionsByListAndParentContentType', [ listId, parentContentTypeId, includeNoContentTypeSpecified ]));
        return $v_1;
    }
}
...
SP.WorkflowServices.WorkflowServicesManagerPropertyNames.serviceHealthStatus = 'ServiceHealthStatus';
...
SP.WorkflowServices.WorkflowSubscriptionPropertyNames.parentContentTypeId = 'ParentContentTypeId';
