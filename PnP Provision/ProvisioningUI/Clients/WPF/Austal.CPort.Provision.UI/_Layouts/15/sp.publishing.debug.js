...
SP.Publishing.ImageRendition.prototype = {
    ...
    writeToXml: function SP_Publishing_ImageRendition$writeToXml(writer, serializationContext) {
        ...
        SP.DataConvert.writeValueToXmlElement(writer, this.$K_1, serializationContext);
...
SP.Publishing.Navigation.NavigationTermProviderNameCollection.prototype = {
    ...
    $O_2: function SP_Publishing_Navigation_NavigationTermProviderNameCollection$$O_2($p0) {
        Array.add(this.get_data(), $p0);
    },
    
    $P_2: function SP_Publishing_Navigation_NavigationTermProviderNameCollection$$P_2() {
    ...
    $Q_2: function SP_Publishing_Navigation_NavigationTermProviderNameCollection$$Q_2($p0) {
